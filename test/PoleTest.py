...
class TestStringMethods(unittest.TestCase):
    ...
    def test_PrimacyRecencyPole(self):
        ...
        # high primacy
        actorlow = Actor([test_polelow], State({"test1": 1, "test2": 0, "test3": 0, "test4": 0}, None), None, None, .05,
                         None, None, [], [])
        actormiddle = Actor([test_polemiddle], State({"test1": 1, "test2": 0, "test3": 0, "test4": 0}, None), None,
                            None, .05, None, None, [], [])
        # high recency
        actorhigh = Actor([test_polehigh], State({"test1": 1, "test2": 0, "test3": 0, "test4": 0}, None), None, None,
                          .05, None, None, [], [])
        ...
        event6 = Event(None, None, Move({"test1": 101, "test2": 100, "test3": 100, "test4": 100}, None, [], .5, None),
                       0)
        event7 = Event(None, None, Move({"test1": 501, "test2": 500, "test3": 500, "test4": 500}, None, [], .5, None),
                       0)
    ...
    def test_RoutineCreativePole(self):
        ...
        # high recency
        actorhigh = Actor([test_polehigh], State({"test1": 1, "test2": 1, "test3": 1, "test4": 1}, None), None, None,
                          .1, None, None, [], [])
